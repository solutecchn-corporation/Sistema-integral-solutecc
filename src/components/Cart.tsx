          ...
          <div style={{ fontSize: 11, color: "#64748b", marginTop: 4 }}>
            ...
            >
              ...
              <strong style={{ color: "#475569" }}>
                L
                {formatMoney(
                  Number(perItemTaxes.reduce((s, it) => s + (it.isv || 0), 0)),
                )}
              </strong>
            </div>
          </div>
              ...
              {perItemTaxes.map((it) => (
                ...
                >
                  ...
                  <div style={{ color: "#64748b", fontSize: 10 }}>
                    ISV: L{formatMoney(it.isv)} • 18%: L{formatMoney(it.imp18)}{" "}
                    • Tur: L{formatMoney(it.tur)}
                  </div>
                </div>
              ))}
            </div>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: "0.75rem", color: "#64748b" }}>
                  ...
                  <span style={{ marginLeft: 8 }}>
                    L{formatMoney(Number(item.producto.precio || 0))} c/u
                  </span>
                </div>
              </div>
