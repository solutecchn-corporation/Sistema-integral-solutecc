...
const GAS_EMAIL_URL =
  (typeof import.meta !== "undefined" &&
    (import.meta as any).env?.VITE_GAS_EMAIL_URL) ||
  "";
...
export default function EmailFacturaModal({
  ...
  const handleSend = async () => {
    ...
    if (!gasUrl) {
      alert(
        "⚠️ No está configurada la URL del servicio de correo (VITE_GAS_EMAIL_URL). Configúrala en el archivo .env para usar esta función.",
      );
      return;
    }
    setSending(true);
            ...
            <>
              ...
              {result === "error" && (
                ...
                >
                  ❌ Error al enviar:{" "}
                  {errorMsg ||
                    "Revisa la URL del servicio de correo (VITE_GAS_EMAIL_URL) en tu .env"}
                </div>
              )}
              ...
              {!gasUrl && (
                ...
                >
                  ⚠️ <strong>VITE_GAS_EMAIL_URL</strong> no configurado.
                  Despliega el <code>Code.gs</code> en Google Apps Script y
                  agrega la URL a tu archivo <code>.env</code>.
                </div>
              )}
              ...
              >
                ...
                <button
                  ...
                  style={{
                    background:
                      !email.trim() || sending ? "#94a3b8" : "#0ea5a4",
                    color: "white",
                    padding: "8px 18px",
                    borderRadius: 8,
                    border: "none",
